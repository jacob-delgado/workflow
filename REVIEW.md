...
| ALL-CAPS eyebrow headings | Met since Phase 13 — every heading in sentence case on the type scale, and the web lint refuses an `uppercase` class (`noAllCaps`, `web/eslint.config.js:37`) | — |
