...
| "Each pane fails on its own" | `docs/content/docs/usage.md:77` | Yes. `internal/tui/tui.go:157` batches six loads; each pane holds and renders its own error. |
