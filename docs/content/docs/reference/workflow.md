...
SLACK — PICK ONE OF TWO
  ...
  3. Put the URL in .workflow.json as slack.webhook_url.
  ...
  3. Install the app to the workspace, then copy the Bot User OAuth Token. It
     starts with "xoxb-".
  4. Put it in .workflow.json as slack.token, and set slack.channel to
...
* [workflow announce](../workflow_announce/)	 - Announce the branch's pull request to Slack
