...
type keyMap struct {
	...
	// Branch and Commits.
	newBranch, switchTask, push, stage, stageAll, commit, runHooks, hookConfig key.Binding
...
func (k keyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.newBranch, k.switchTask, k.push, k.stage, k.stageAll, k.commit, k.runHooks, k.hookConfig},
