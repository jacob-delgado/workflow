...
type keyMap struct {
	...
	// Issues.
	changeStatus, comment, branchForIssue, filter, nextView, loadMore key.Binding

	// Branch and Commits.
	newBranch, switchTask, worktree, rebase, push, stage, stageAll, commit, runHooks, hookConfig key.Binding
